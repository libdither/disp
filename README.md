...
- Legacy spec (seven kernel primitives) — removed; recoverable from git history (was `archive/TYPE_THEORY_LEGACY.typ`). The codebase has migrated off it to the two-Σ-op shape.
