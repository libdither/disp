...
> Archived 2026-08-17 alongside the kernel whose formers it designs (archive/live-kernel/).
...
- **Metacircular self-typing of the telescope machinery.** Cells are now wait-forms
  ...
  (`archive/live-kernel/tests/strict_type.test.disp`). What remains is the *respond* side: a strict
