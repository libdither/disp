...
This is the ecosystem where disp's G5 has actually been demonstrated end-to-end:
...
Verus is the **anti-disp on G1–G3 and equality** and the **proof of concept for G5**. It
