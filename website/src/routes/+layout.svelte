...
<div class="shell">
    ...
    <nav class="container navbar">
      <a class="brand" href="{base}/" aria-label="disp home">
        <svg class="glyph" viewBox="0 0 32 32" aria-hidden="true">
          ...
          <g stroke="var(--bark)" stroke-width="2.2" stroke-linecap="round" fill="none">
            <path d="M16 25 L16 15 M16 17 C16 13 11 12 9 9 M16 19 C16 15 21 14 23 11" />
          </g>
          ...
          {:else}
            <a class="navlink" class:active={isActive(l.href)} href={l.href}>
              ...
              <svg class="sprout" viewBox="0 0 24 12" aria-hidden="true">
                ...
                <path class="leaf l1" d="M12 7 C9.5 6.5 8 4.5 7.6 2.4 C10 2.8 11.7 4.4 12 7 Z" />
                <path class="leaf l2" d="M12 6 C14.3 5.4 15.7 3.8 16.2 1.6 C13.9 2 12.3 3.6 12 6 Z" />
              </svg>
            </a>
          {/if}
        {/each}
  ...
  <footer class="footer">
    <svg class="treeline" viewBox="0 0 1200 46" preserveAspectRatio="none" aria-hidden="true">
      <path
...
<style>
  ...
  .sprout .stem { stroke: var(--g2); stroke-width: 1.6; fill: none; stroke-linecap: round; }
  .sprout .leaf { fill: var(--g1); }
  ...
  .footer {
    ...
    margin-top: 4rem;
    background:
      radial-gradient(60% 120% at 15% 100%, color-mix(in oklab, var(--g1) 9%, transparent), transparent 70%),
