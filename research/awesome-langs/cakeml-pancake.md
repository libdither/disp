...
| G4 Execution | ◐ 62% (verified native) | Verified native code. Pancake drivers are performant and run in production-ish settings (LionsOS/seL4). | 1 · 1 · 0 · ½ — verified native code, the compiler proved down to the binary; the proved passes are fixed, not user-defined; no cost model |
