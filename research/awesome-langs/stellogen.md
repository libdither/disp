...
| G4 Execution | ✗ 0% (none) | None; docs admit concrete execution "has a horrible complexity" (repeated graph isomorphism). | 0 · 0 · 0 — execution has "a horrible complexity" |
