...
| G2 Specification | ✗ 20% (math prover) | A real theorem-proving language, but aimed at mathematics; not dependent-type-strength program specification. Equality: Not addressed for program rewriting. | 0 · 1 · 0 · 0 — a theorem-proving language for mathematics with a growing library; no program specifications |
...
| G4 Execution | ✗ 0% (none) | Not a systems language at all. | 0 · 0 · 0 — not a systems language |
